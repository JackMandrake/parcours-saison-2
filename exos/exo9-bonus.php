...
include 'exo9/datas/characters.php';
ob_start();


/**
 * ===== Exo 9 - Bonus : Le Comparateur de personnages ====
 * 
 ...
 * (Tu peux les voir dans le fichier 'exo9/datas/characters.php')
 *
 * 
 * 
 * Etape 1 : 
 * Afficher le premier personnage, sa photo et les caractéristiques contenus dans le tableau $characters 
 * Mettre en forme grâce à du HTML et du CSS (tu peux mettre ton CSS dans exo9/css/styles.css)
 * 
 * Etape 2 :
